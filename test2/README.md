...
- Полнота описания 0–100, разбивка по компонентам и рекомендации по заполнению.
- Ручное подтверждение карточки и отдельная публикация.
- Каталог с фильтрами темы и полноты описания, сортировкой и пагинацией.
...
| --- | --- |
| 0–39 | draft / Мало деталей |
| 40–69 | workable / Часть описана |
| 70–89 | ready / Много деталей |
| 90–100 | priority / Подробное описание |
...
На телефоне дополнительные параметры открываются кнопкой «Фильтры»; активные
ограничения можно убрать по отдельности. Баллы в UI подписаны как «Полнота описания».
...
3. Нажмите **«Собрать карточку»**. Ожидаемый рейтинг — **50/100, Часть описана**.
4. Введите название **«Реестр заявок мастерской — демо»**, в поле «Данные и материалы» —
   **«Обезличенный CSV с заявками»**. Нажмите **«Сохранить»**.
   Ожидаемый рейтинг — **70/100, Много деталей**. Остальные поля пока не заполняйте.
